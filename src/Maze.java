...
public class Maze {
	...
	public static final int HEIGHT = WIDTH; //одинаковые для удобства
	public static final int W = 20;
	
	public static int speed = 1;
	public static boolean generated, solved;
	
	private static final String[] GENERATION_METHODS = {
			 "0. Kruskal's", "1. Prim's"};
	private static final String[] SOLVING_METHODS = {"0. Breadth First Search", "1. Dijkstra's"};
	...
	private void createAndShowGUI() {
		JFrame frame = new JFrame("Лабиринт Крускала и Прима");
		...
		solveButton.addActionListener(event -> {
			if (generated) {
				...
				JOptionPane.showMessageDialog(frame, "Подождите пока лабиринт сгенерируется");
			}
		});
		...
		solveAgainButton.addActionListener(event -> {
			if (solved) {
				...
				JOptionPane.showMessageDialog(frame, "Подождите пока лабиринт будет решён");
			}
		});
